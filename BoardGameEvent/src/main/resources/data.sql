...
INSERT INTO events (event_name, description, location, event_date, players, curr_players, rating, game_id)
VALUES ('Chess championship', 'Standard chess rules, 10min per game, 4 boards', 'Aloha bar', '2024-05-10 12:00:00', 20, 0, 4.57, 7),
       ('Catan championship', 'Standard Catan rules, 30min per game, 4 boards', 'Evening caffe', '2024-08-13 10:00:00', 10,0, 4.28, 8),
       ('Terraforming Mars event', 'Standard Terraforming Mars rules, 40min per game, 1 board', 'Meow anticaffe', '2024-06-10 10:00:00', 5,0, 4.9, 9),
       ('Pixies event', 'Standard Pixies rules, 5min per game, 2 boards', 'Verdana place', '2024-05-18 18:00:00', 6,0, 3.18, 10),
       ('Monopoly event', 'Standard Monopoly rules, 30min per game, 1 board', 'Trade bar', '2024-05-19 19:00:00', 20,0, 4.01, 11),
       ('Chess championship', 'Standard chess rules, 10min per game, 4 boards', 'Greenwich bar', '2024-05-9 16:00:00', 10,0, 4.7, 12);